...
import com.donniebirb.stealthpixeldungeon.windows.WndDailies;
import com.donniebirb.stealthpixeldungeon.windows.WndRanking;
		...
		if (Rankings.INSTANCE.latestDaily != null) {
			IconButton btnDailies = new IconButton(Icons.CALENDAR.get()) {
				...
				protected void onClick() {
					StealthPixelDungeon.scene().addToFront(new WndDailies());
				}
