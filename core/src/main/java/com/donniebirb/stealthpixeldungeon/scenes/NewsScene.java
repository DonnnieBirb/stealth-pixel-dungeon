...
import com.donniebirb.stealthpixeldungeon.services.news.NewsArticle;
...
import com.donniebirb.stealthpixeldungeon.windows.WndTitledMessage;
...
public class NewsScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnSite = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(this, "read_more")){
			...
			protected void onClick() {
				...
				StealthPixelDungeon.platform.openURI(link);
			}
		};
	...
	private static class ArticleButton extends StyledButton {
		...
		protected void onClick() {
			...
			StealthPixelDungeon.scene().addToFront(new WndArticle(article));
		}
	}
