...
import com.donniebirb.stealthpixeldungeon.effects.Fireball;
import com.donniebirb.stealthpixeldungeon.messages.Languages;
import com.donniebirb.stealthpixeldungeon.messages.Messages;
import com.donniebirb.stealthpixeldungeon.services.news.News;
import com.donniebirb.stealthpixeldungeon.services.updates.AvailableUpdateData;
import com.donniebirb.stealthpixeldungeon.services.updates.Updates;
...
import com.donniebirb.stealthpixeldungeon.windows.WndSettings;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnPlay = new StyledButton(GREY_TR, Messages.get(this, "enter")){
			...
			protected void onClick() {
				if (GamesInProgress.checkAll().size() == 0){
					...
					StealthPixelDungeon.switchNoFade( StartScene.class );
				}
			}
		...
		StyledButton btnRankings = new StyledButton(GREY_TR,Messages.get(this, "rankings")){
			@Override
			protected void onClick() {
				StealthPixelDungeon.switchNoFade( RankingsScene.class );
			}
		};
		...
		StyledButton btnBadges = new StyledButton(GREY_TR, Messages.get(this, "badges")){
			@Override
			protected void onClick() {
				StealthPixelDungeon.switchNoFade( BadgesScene.class );
			}
		};
		...
		StyledButton btnAbout = new StyledButton(GREY_TR, Messages.get(this, "about")){
			@Override
			protected void onClick() {
				StealthPixelDungeon.switchScene( AboutScene.class );
			}
		};
	...
	private static class NewsButton extends StyledButton {
		...
		protected void onClick() {
			super.onClick();
			StealthPixelDungeon.switchNoFade( NewsScene.class );
		}
	}
				...
				StealthPixelDungeon.scene().addToFront(new WndOptions(
					...
					protected void onSelect(int index) {
						if (index == 0) {
							...
							StealthPixelDungeon.switchNoFade( ChangesScene.class );
						}
					}
				});
	...
	private static class SettingsButton extends StyledButton {
		...
		protected void onClick() {
			...
			StealthPixelDungeon.scene().add(new WndSettings());
		}
	}
	...
	private static class SupportButton extends StyledButton{
		...
		@Override
		protected void onClick() {
			StealthPixelDungeon.switchNoFade(SupporterScene.class);
		}
	}
}
