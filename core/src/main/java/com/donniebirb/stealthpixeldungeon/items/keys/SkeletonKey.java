...
package com.donniebirb.stealthpixeldungeon.items.keys;
...
import com.donniebirb.stealthpixeldungeon.windows.WndSupportPrompt;
		...
		if(!SPDSettings.supportNagged()){
			try {
				...
				Game.runOnRenderThread(new Callback() {
					@Override
					public void call() {
						StealthPixelDungeon.scene().add(new WndSupportPrompt());
					}
				});
			} catch (IOException e) {
