...
package com.donniebirb.stealthpixeldungeon.items.artifacts;
...
import com.donniebirb.stealthpixeldungeon.effects.particles.ShaftParticle;
...
import com.donniebirb.stealthpixeldungeon.sprites.GhostSprite;
...
import com.donniebirb.stealthpixeldungeon.windows.WndBlacksmith;
import com.donniebirb.stealthpixeldungeon.windows.WndQuest;
...
public class DriedRose extends Artifact {
	...
	public String desc() {
		if (!Ghost.Quest.completed()
				&& (StealthPixelDungeon.scene() instanceof GameScene || StealthPixelDungeon.scene() instanceof AlchemyScene)){
