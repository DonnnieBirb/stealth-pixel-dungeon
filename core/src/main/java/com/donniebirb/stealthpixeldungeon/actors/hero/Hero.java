...
package com.donniebirb.stealthpixeldungeon.actors.hero;

import com.donniebirb.stealthpixeldungeon.Assets;
import com.donniebirb.stealthpixeldungeon.Badges;
import com.donniebirb.stealthpixeldungeon.Bones;
import com.donniebirb.stealthpixeldungeon.Dungeon;
import com.donniebirb.stealthpixeldungeon.GamesInProgress;
import com.donniebirb.stealthpixeldungeon.SPDSettings;
...
import com.donniebirb.stealthpixeldungeon.actors.blobs.SacrificialFire;
import com.donniebirb.stealthpixeldungeon.actors.buffs.AdrenalineSurge;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Amok;
import com.donniebirb.stealthpixeldungeon.actors.buffs.AnkhInvulnerability;
...
import com.donniebirb.stealthpixeldungeon.actors.buffs.Awareness;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Barkskin;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Barrier;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Berserk;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Bless;
...
import com.donniebirb.stealthpixeldungeon.actors.buffs.Combo;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Drowsy;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Foresight;
import com.donniebirb.stealthpixeldungeon.actors.buffs.HoldFast;
...
import com.donniebirb.stealthpixeldungeon.actors.buffs.Levitation;
import com.donniebirb.stealthpixeldungeon.actors.buffs.LostInventory;
import com.donniebirb.stealthpixeldungeon.actors.buffs.MindVision;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Momentum;
import com.donniebirb.stealthpixeldungeon.actors.buffs.MonkEnergy;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Paralysis;
import com.donniebirb.stealthpixeldungeon.actors.buffs.PhysicalEmpower;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Recharging;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Regeneration;
import com.donniebirb.stealthpixeldungeon.actors.buffs.SnipersMark;
import com.donniebirb.stealthpixeldungeon.actors.buffs.Vertigo;
import com.donniebirb.stealthpixeldungeon.actors.hero.abilities.ArmorAbility;
import com.donniebirb.stealthpixeldungeon.actors.hero.abilities.duelist.Challenge;
import com.donniebirb.stealthpixeldungeon.actors.hero.abilities.duelist.ElementalStrike;
import com.donniebirb.stealthpixeldungeon.actors.hero.abilities.huntress.NaturesPower;
import com.donniebirb.stealthpixeldungeon.actors.hero.abilities.warrior.Endure;
import com.donniebirb.stealthpixeldungeon.actors.mobs.Mimic;
import com.donniebirb.stealthpixeldungeon.actors.mobs.Mob;
import com.donniebirb.stealthpixeldungeon.actors.mobs.Monk;
import com.donniebirb.stealthpixeldungeon.actors.mobs.Snake;
import com.donniebirb.stealthpixeldungeon.effects.CellEmitter;
import com.donniebirb.stealthpixeldungeon.effects.CheckedCell;
import com.donniebirb.stealthpixeldungeon.effects.Speck;
import com.donniebirb.stealthpixeldungeon.effects.SpellSprite;
import com.donniebirb.stealthpixeldungeon.items.Amulet;
import com.donniebirb.stealthpixeldungeon.items.Ankh;
import com.donniebirb.stealthpixeldungeon.items.Dewdrop;
import com.donniebirb.stealthpixeldungeon.items.EquipableItem;
import com.donniebirb.stealthpixeldungeon.items.Heap;
import com.donniebirb.stealthpixeldungeon.items.Heap.Type;
import com.donniebirb.stealthpixeldungeon.items.Item;
import com.donniebirb.stealthpixeldungeon.items.KindOfWeapon;
import com.donniebirb.stealthpixeldungeon.items.armor.Armor;
import com.donniebirb.stealthpixeldungeon.items.armor.ClassArmor;
import com.donniebirb.stealthpixeldungeon.items.armor.glyphs.AntiMagic;
import com.donniebirb.stealthpixeldungeon.items.armor.glyphs.Brimstone;
import com.donniebirb.stealthpixeldungeon.items.armor.glyphs.Viscosity;
import com.donniebirb.stealthpixeldungeon.items.artifacts.AlchemistsToolkit;
import com.donniebirb.stealthpixeldungeon.items.artifacts.CapeOfThorns;
...
import com.donniebirb.stealthpixeldungeon.items.bags.MagicalHolster;
import com.donniebirb.stealthpixeldungeon.items.journal.Guidebook;
import com.donniebirb.stealthpixeldungeon.items.keys.CrystalKey;
import com.donniebirb.stealthpixeldungeon.items.keys.GoldenKey;
import com.donniebirb.stealthpixeldungeon.items.keys.IronKey;
import com.donniebirb.stealthpixeldungeon.items.keys.Key;
import com.donniebirb.stealthpixeldungeon.items.keys.SkeletonKey;
...
import com.donniebirb.stealthpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.donniebirb.stealthpixeldungeon.items.potions.exotic.PotionOfDivineInspiration;
import com.donniebirb.stealthpixeldungeon.items.quest.DarkGold;
import com.donniebirb.stealthpixeldungeon.items.quest.Pickaxe;
...
import com.donniebirb.stealthpixeldungeon.items.scrolls.exotic.ScrollOfChallenge;
...
import com.donniebirb.stealthpixeldungeon.items.weapon.SpiritBow;
...
import com.donniebirb.stealthpixeldungeon.journal.Document;
import com.donniebirb.stealthpixeldungeon.journal.Notes;
import com.donniebirb.stealthpixeldungeon.levels.Level;
import com.donniebirb.stealthpixeldungeon.levels.MiningLevel;
import com.donniebirb.stealthpixeldungeon.levels.Terrain;
import com.donniebirb.stealthpixeldungeon.levels.features.Chasm;
import com.donniebirb.stealthpixeldungeon.levels.features.LevelTransition;
import com.donniebirb.stealthpixeldungeon.levels.traps.Trap;
import com.donniebirb.stealthpixeldungeon.mechanics.ShadowCaster;
...
import com.donniebirb.stealthpixeldungeon.scenes.InterlevelScene;
import com.donniebirb.stealthpixeldungeon.scenes.PixelScene;
import com.donniebirb.stealthpixeldungeon.scenes.SurfaceScene;
import com.donniebirb.stealthpixeldungeon.sprites.CharSprite;
import com.donniebirb.stealthpixeldungeon.sprites.HeroSprite;
...
import com.donniebirb.stealthpixeldungeon.ui.AttackIndicator;
import com.donniebirb.stealthpixeldungeon.ui.BuffIndicator;
import com.donniebirb.stealthpixeldungeon.ui.QuickSlotButton;
import com.donniebirb.stealthpixeldungeon.ui.StatusPane;
import com.donniebirb.stealthpixeldungeon.utils.GLog;
import com.donniebirb.stealthpixeldungeon.windows.WndHero;
import com.donniebirb.stealthpixeldungeon.windows.WndMessage;
import com.donniebirb.stealthpixeldungeon.windows.WndOptions;
import com.donniebirb.stealthpixeldungeon.windows.WndResurrect;
import com.donniebirb.stealthpixeldungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			StealthPixelDungeon.switchScene(AlchemyScene.class);
			return false;
