...
import com.donniebirb.stealthpixeldungeon.scenes.StartScene;
	...
	public WndGameInProgress(final int slot){
		...
		RedButton cont = new RedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				StealthPixelDungeon.switchScene(InterlevelScene.class);
			}
		};
		...
		RedButton erase = new RedButton( Messages.get(this, "erase")){
			...
			protected void onClick() {
				...
				StealthPixelDungeon.scene().add(new WndOptions(Icons.get(Icons.WARNING),
