...
import com.donniebirb.stealthpixeldungeon.ui.BadgesGrid;
import com.donniebirb.stealthpixeldungeon.ui.BadgesList;
import com.donniebirb.stealthpixeldungeon.ui.Button;
...
import com.donniebirb.stealthpixeldungeon.ui.ItemSlot;
import com.donniebirb.stealthpixeldungeon.ui.RedButton;
import com.donniebirb.stealthpixeldungeon.ui.RenderedTextBlock;
import com.donniebirb.stealthpixeldungeon.ui.TalentButton;
import com.donniebirb.stealthpixeldungeon.ui.TalentsPane;
		...
		public StatsTab() {
			...
			if (Dungeon.hero == null){
				...
				IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)) {
					...
					protected void onClick() {
						super.onClick();
						StealthPixelDungeon.scene().addToFront(new WndScoreBreakdown());
					}
				};
			...
			if (Dungeon.hero != null && Dungeon.seed != -1 && !Dungeon.daily &&
				...
				RedButton btnSeed = new RedButton(Messages.get(this, "copy_seed")){
					...
					protected void onClick() {
						super.onClick();
						StealthPixelDungeon.scene().addToFront(new WndOptions(new Image(icon),
