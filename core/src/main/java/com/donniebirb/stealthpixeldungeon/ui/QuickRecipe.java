...
package com.donniebirb.stealthpixeldungeon.ui;

import com.donniebirb.stealthpixeldungeon.Dungeon;
import com.donniebirb.stealthpixeldungeon.StealthPixelDungeon;
import com.donniebirb.stealthpixeldungeon.items.ArcaneResin;
import com.donniebirb.stealthpixeldungeon.items.Generator;
import com.donniebirb.stealthpixeldungeon.items.Item;
import com.donniebirb.stealthpixeldungeon.items.LiquidMetal;
import com.donniebirb.stealthpixeldungeon.items.Recipe;
import com.donniebirb.stealthpixeldungeon.items.bombs.Bomb;
import com.donniebirb.stealthpixeldungeon.items.food.Blandfruit;
import com.donniebirb.stealthpixeldungeon.items.food.Food;
import com.donniebirb.stealthpixeldungeon.items.food.MeatPie;
...
import com.donniebirb.stealthpixeldungeon.items.food.StewedMeat;
...
import com.donniebirb.stealthpixeldungeon.items.potions.brews.BlizzardBrew;
import com.donniebirb.stealthpixeldungeon.items.potions.brews.CausticBrew;
import com.donniebirb.stealthpixeldungeon.items.potions.brews.InfernalBrew;
import com.donniebirb.stealthpixeldungeon.items.potions.brews.ShockingBrew;
import com.donniebirb.stealthpixeldungeon.items.potions.elixirs.ElixirOfAquaticRejuvenation;
import com.donniebirb.stealthpixeldungeon.items.potions.elixirs.ElixirOfArcaneArmor;
import com.donniebirb.stealthpixeldungeon.items.potions.elixirs.ElixirOfDragonsBlood;
import com.donniebirb.stealthpixeldungeon.items.potions.elixirs.ElixirOfHoneyedHealing;
import com.donniebirb.stealthpixeldungeon.items.potions.elixirs.ElixirOfIcyTouch;
import com.donniebirb.stealthpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.donniebirb.stealthpixeldungeon.items.potions.elixirs.ElixirOfToxicEssence;
import com.donniebirb.stealthpixeldungeon.items.potions.exotic.ExoticPotion;
import com.donniebirb.stealthpixeldungeon.items.scrolls.Scroll;
import com.donniebirb.stealthpixeldungeon.items.scrolls.exotic.ExoticScroll;
import com.donniebirb.stealthpixeldungeon.items.spells.Alchemize;
import com.donniebirb.stealthpixeldungeon.items.spells.AquaBlast;
import com.donniebirb.stealthpixeldungeon.items.spells.ArcaneCatalyst;
import com.donniebirb.stealthpixeldungeon.items.spells.BeaconOfReturning;
import com.donniebirb.stealthpixeldungeon.items.spells.CurseInfusion;
import com.donniebirb.stealthpixeldungeon.items.spells.FeatherFall;
import com.donniebirb.stealthpixeldungeon.items.spells.MagicalInfusion;
import com.donniebirb.stealthpixeldungeon.items.spells.PhaseShift;
import com.donniebirb.stealthpixeldungeon.items.spells.ReclaimTrap;
import com.donniebirb.stealthpixeldungeon.items.spells.Recycle;
import com.donniebirb.stealthpixeldungeon.items.spells.SummonElemental;
import com.donniebirb.stealthpixeldungeon.items.spells.TelekineticGrab;
import com.donniebirb.stealthpixeldungeon.items.spells.WildEnergy;
...
public class QuickRecipe extends Component {
	...
	public QuickRecipe(Recipe r, ArrayList<Item> inputs, final Item output) {
		...
		for (final Item in : inputs) {
			...
			curr = new ItemSlot(in) {
				...
				protected void onClick() {
					StealthPixelDungeon.scene().addToFront(new WndInfoItem(in));
				}
			};
		...
		this.output = new ItemSlot(output){
			@Override
			protected void onClick() {
				StealthPixelDungeon.scene().addToFront(new WndInfoItem(output));
			}
		};
		if (!hasInputs){
	...
	public class arrow extends IconButton {
		...
		protected void onClick() {
			...
			((AlchemyScene) StealthPixelDungeon.scene()).populate(ingredients, Dungeon.hero.belongings);
		}
